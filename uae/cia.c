...
UBYTE ciaaicr,ciaaimask,ciabicr,ciabimask;
UBYTE ciaacra,ciaacrb,ciabcra,ciabcrb;
ULONG ciaata,ciaatb,ciabta,ciabtb;
static UWORD ciaala,ciaalb,ciabla,ciablb;
ULONG ciaatod,ciabtod,ciaatol,ciabtol,ciaaalarm,ciabalarm;
...
{
    static int keytime = 0, sleepyhead = 0;
...
static ULONG cia_wget(CPTR) REGPARAM;
static ULONG cia_bget(CPTR) REGPARAM;
static void  cia_lput(CPTR, ULONG) REGPARAM;
static void  cia_wput(CPTR, ULONG) REGPARAM;
static void  cia_bput(CPTR, ULONG) REGPARAM;
...
ULONG REGPARAM2 cia_lget(CPTR addr)
{
    return cia_bget(addr+3);
}

ULONG REGPARAM2 cia_wget(CPTR addr)
{
    return cia_bget(addr+1);
}

ULONG REGPARAM2 cia_bget(CPTR addr)
{
...
void REGPARAM2 cia_lput(CPTR addr, ULONG value)
{
    cia_bput(addr+3,value); /* FIXME ? */
}

void REGPARAM2 cia_wput(CPTR addr, ULONG value)
{
    cia_bput(addr+1,value);
}

void REGPARAM2 cia_bput(CPTR addr, ULONG value)
{
    if ((addr & 0x3001) == 0x2001)
...
static ULONG clock_wget(CPTR) REGPARAM;
static ULONG clock_bget(CPTR) REGPARAM;
static void  clock_lput(CPTR, ULONG) REGPARAM;
static void  clock_wput(CPTR, ULONG) REGPARAM;
static void  clock_bput(CPTR, ULONG) REGPARAM;
...
ULONG REGPARAM2 clock_lget(CPTR addr)
{
    return clock_bget(addr+3);
}

ULONG REGPARAM2 clock_wget(CPTR addr)
{
    return clock_bget(addr+1);
}

ULONG REGPARAM2 clock_bget(CPTR addr)
{
    time_t t=time(0);
    struct tm *ct;
    ct=localtime(&t);
...
void REGPARAM2 clock_lput(CPTR addr, ULONG value)
{
    /* No way */
}

void REGPARAM2 clock_wput(CPTR addr, ULONG value)
{
    /* No way */
}

void REGPARAM2 clock_bput(CPTR addr, ULONG value)
{
    switch (addr & 0x3f)
    {
